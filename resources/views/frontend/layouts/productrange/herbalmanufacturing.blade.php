...
@section('content')
    ...
    <section class="relative z-20">
        <div class="relative w-full h-full ">
            <!-- Background Image -->
            <img src="{{ asset('images/herbbanner.png') }}" alt="Private Labelling Banner"
    ...
    <section class='relative'>
        <img src="{{ asset('images/aboutus/SDA1.png') }}" alt=""
            class='absolute inset-0 h-28 md:h-52 top-28 z-10 md:top-16'>
            ...
            <div class=" container mx-auto flex flex-col justify-center items-center ">
                ...
                <div class="flex flex-col lg:flex-row  gap-10 items-center ">
                    ...
                    <div class="w-full  space-y-6">
                        <h3 class="text-3xl md:text-4xl font-bold text-black uppercase leading-tight">
                            Moringa Powder
                        </h3>
                    ...
                    <div class="max-w-[424px] max-h-[424px] min-w-[224px] min-h-[224px]  flex justify-center">
                        <img src="{{ asset('images/herbs.png') }}" alt="Cordyceps Capsules"
