...
@section('content')
    ...
    <section class="relative z-20">
        <div class="relative w-full h-full ">
            ...
            <!-- Background Image -->
            <img src="{{ asset('images/DRIEDbanner.png') }}" alt="Private Labelling Banner"
    ...
    <section class="max-w-7xl mx-auto px-4 py-16 md:py-24 border-b border-gray-100">
        ...
        <!-- Product List -->
        <div class=" container mx-auto flex flex-col justify-center items-center space-y-5 ">
            ...
            <div class="flex flex-col lg:flex-row  gap-10 items-center">
                <div class="max-w-[424px] max-h-[424px] min-w-[224px] min-h-[224px]  flex justify-center">
                    <img src="{{ asset('images/dried.png') }}" alt="Shilajit Trifala Mix"
